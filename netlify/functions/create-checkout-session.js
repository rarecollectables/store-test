...
//           details:
//             'Please set STRIPE_SECRET_KEY in Netlify environment variables',
//         }),
//       };
//     }
...
//             );
//             console.log(
//               `Applied ${promo.coupon.percent_off}% discount for coupon: ${coupon}`,
//             );
//           } else if (promo.coupon.amount_off) {
//             // Fixed amount discount
//             calculatedDiscountAmountCents = promo.coupon.amount_off;
//             console.log(
//               `Applied fixed discount of ${promo.coupon.amount_off / 100} ${
//                 promo.coupon.currency
//               } for coupon: ${coupon}`,
//             );
//           }
//         } else {
...
//         });
//         throw new Error(
//           `Invalid cart item ${index + 1}: Missing required fields`,
//         );
//       }
...
//     console.log(
//       `Proceeding with payment intent creation with coupon: ${
//         coupon || 'none'
//       }`,
//     );
//     console.log(
//       `Applied discount amount: ${calculatedDiscountAmountCents / 100} GBP`,
//     );
...
//             'paypal',
//           ],
//       // payment_method_types: payment_method_types || ['card', 'link'],
//       mode: 'payment',
//       line_items,
...
exports.handler = async event => {
  ...
  try {
    ...
    // ✅ Apply promotion_code (not coupon directly!)
    if (promoCodeId) {
