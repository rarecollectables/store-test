...
export default function ProductCard({item, cardWidth, disableImageCycling}) {
  ...
  const PLACEHOLDER_IMAGE =
    'https://fhybeyomiivepmlrampr.supabase.co/storage/v1/object/public/utils//brandLogo.webp';
  ...
  }, [images.length, disableImageCycling]);
  ...
  return (
    <Pressable
      ...
      <View style={styles.imageContainer}>
        ...
        <ImageBackground
          source={{
            uri: allImagesFailed ? PLACEHOLDER_IMAGE : images[currentIndex],
          }}
          style={styles.image}
          imageStyle={styles.imageStyle}
          onLoadStart={() => setImageLoading(true)}
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.colorSwatches}>
          ...
          {/* {(item?.colors || ['#d4af37', '#f1c27b', '#a52a2a']).map(
            (color, index) => (
              <View
                key={index}
